    ...
    while ogre.is_alive() and my_hero.is_alive():
        if Help1 == "YES":
            ...
            if ogre.health <= 0:
                ...
                ("You feel as the spikes are pulling you down and start to look around as you see Hell all around you...What will " + name + " do next?")
                print("\n\n\n The End.")
        if Help1 == "NO":
            ...
            while dragon.is_alive() and my_hero.is_alive():
                    ...
                    if dragon.health <= 0:
                        ...
                        print("You feel as the spikes are pulling you down and start to look around as you see Hell all around you...What will " + name + " do next?")
            break
main()